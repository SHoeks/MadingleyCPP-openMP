...
public:
    ...
    Cohort( GridCell&, unsigned, double, double, double, double, double, unsigned short, double, long long&, double, double, unsigned );
    ...
    @param birthTimeStep The birth time step for this cohort
    @param nextCohortID The unique ID to assign to the next cohort created    */
    Cohort( Cohort*, double, double, double, double, double, unsigned, long long&, double );
