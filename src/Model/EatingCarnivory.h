...
public:
    ...
    double CalculateExpectedNumberKilledTerrestrial( double, double, int, int, double, bool, bool, bool, double, int, MadingleyInitialisation& );
    ...
    @param logOptimalPreyPredatorMassRatio The log ratio of optimal prey body mass to predator body mass
    @return The potential number of individuals in a prey cohort eaten by an acting predator cohort*/
    double CalculateExpectedNumberKilledMarine( double, double, int, int, double, bool, bool, bool, double, int, MadingleyInitialisation& );
    ...
    double CalculateIndividualKillingRatePerHectare( double, int, int, double, double, int, MadingleyInitialisation& );
